...
enum MemberRole {
  ORGANIZER = "ORGANIZER",
  MODERATOR = "MODERATOR",enum BookGenre {
  FICTION = "FICTION",
  NON_FICTION = "NON_FICTION",
  MYSTERY = "MYSTERY",
  SCIENCE_FICTION = "SCIENCE_FICTION",
...
const books: { title: string; author: string; genre: BookGenre }[] = [
  ...
  { title: "Book 6", author: "Ashish", genre: BookGenre.FANTASY },
  { title: "Book 7", author: "Vaishnavi", genre: BookGenre.MYSTERY },
  { title: "Book 8", author: "Abhay", genre: BookGenre.NON_FICTION },
  { title: "Book 9", author: "Priyanka", genre: BookGenre.SCIENCE_FICTION },
];
